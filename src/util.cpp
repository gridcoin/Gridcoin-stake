...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\GridcoinStake
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\GridcoinStake
    // Mac: ~/Library/Application Support/GridcoinStake
    // Unix: ~/.gridcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GridcoinStake";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "gridcoinstake.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "gridcoinstake.pid"));
